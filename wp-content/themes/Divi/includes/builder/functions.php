...
if ( ! defined( 'ET_BUILDER_PRODUCT_VERSION' ) ) {
	...
	define( 'ET_BUILDER_PRODUCT_VERSION', '4.0.4' );
}
...
function et_fb_current_page_params() {
	...
	$exclude_woo = wp_doing_ajax() || ! et_is_woocommerce_plugin_active() || 'product' !== get_post_type();
...
function et_pb_get_page_custom_css( $post_id = 0 ) {
	...
	if ( $wrap_selector ) {
		$selector_prefix = ' ' . ET_BUILDER_CSS_PREFIX;
	}
