...
function et_builder_tb_enabled() {
	return et_core_is_fb_enabled() && et_pb_is_allowed( 'theme_builder' ) && isset( $_GET['et_tb'] ) && '1' === $_GET['et_tb'];
}
...
function et_builder_maybe_wrap_css_selector( $selector, $suffix = '', $clone = true ) {
	...
	if ( ! isset( $should_wrap_selectors[ $post_id ] ) ) {
		$should_wrap_selectors[ $post_id ] = et_pb_is_pagebuilder_used( $post_id ) && (et_is_builder_plugin_active() || et_builder_post_is_of_custom_post_type( $post_id ) || et_theme_builder_is_layout_post_type( get_post_type( $post_id ) ));
	}
...
function et_builder_maybe_wrap_css_selectors( $selector, $clone = true ) {
	...
	if ( ! isset( $should_wrap_selectors[ $post_id ] ) ) {
		...
		$should_wrap_selectors[ $post_id ] = et_pb_is_pagebuilder_used( $wrap_post_id ) && ( et_is_builder_plugin_active() || et_builder_post_is_of_custom_post_type( $wrap_post_id ) );
	}
