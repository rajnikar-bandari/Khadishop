...
//						'hook'       => "wdp_{$type}_bulk_table_action",
	...
	protected function get_discount_message_options( $panel_id ) {
		...
		$sections = array(
			"{$panel_id}-global"     => array(
				...
				'options'  => array(
					'amount_saved_label'   => array(
						...
						'default'           => isset( $options['amount_saved_label'] ) ? $options['amount_saved_label'] : __( "Amount Saved", 'advanced-dynamic-pricing-for-woocommerce' ),
						'priority' => 5,
			...
			"{$panel_id}-" . WDP_Discount_Message::CONTEXT_CART     => array(
				'title'    => __( 'Cart', 'advanced-dynamic-pricing-for-woocommerce' ),
				'priority' => 10,
				'options'  => array(
					'enable'   => array(
						'label'             => __( 'Enable', 'advanced-dynamic-pricing-for-woocommerce' ),
						'default'           => isset( $options['is_show_amount_saved_in_cart'] ) ? $options['is_show_amount_saved_in_cart'] : false,
						'priority'          => 5,
						'control_type'      => 'checkbox',
						'sanitize_callback' => 'wc_string_to_bool',
					...
					'position' => array(
						...
						'control_type' => 'select',
						'choices'      => apply_filters( "wdp_" . WDP_Discount_Message::CONTEXT_CART . "_discount_message_places", array(
			...
			"{$panel_id}-" . WDP_Discount_Message::CONTEXT_MINI_CART => array(
				'title'    => __( 'Mini Cart', 'advanced-dynamic-pricing-for-woocommerce' ),
				'priority' => 15,
				'options'  => array(
					'enable'   => array(
						'label'             => __( 'Enable', 'advanced-dynamic-pricing-for-woocommerce' ),
						'default'           => isset( $options['is_show_amount_saved_in_mini_cart'] ) ? $options['is_show_amount_saved_in_mini_cart'] : false,
						'priority'          => 5,
						'control_type'      => 'checkbox',
						'sanitize_callback' => 'wc_string_to_bool',
					...
					'position' => array(
						...
						'control_type' => 'select',
						'choices'      => apply_filters( "wdp_" . WDP_Discount_Message::CONTEXT_MINI_CART . "_discount_message_places", array(
			...
			"{$panel_id}-" . WDP_Discount_Message::CONTEXT_CHECKOUT  => array(
				'title'    => __( 'Checkout', 'advanced-dynamic-pricing-for-woocommerce' ),
				'priority' => 20,
				'options'  => array(
					'enable'   => array(
						'label'             => __( 'Enable', 'advanced-dynamic-pricing-for-woocommerce' ),
						'default'           => isset( $options['is_show_amount_saved_in_checkout_cart'] ) ? $options['is_show_amount_saved_in_checkout_cart'] : false,
						'priority'          => 5,
						'control_type'      => 'checkbox',
						'sanitize_callback' => 'wc_string_to_bool',
					...
					'position' => array(
						...
						'control_type' => 'select',
						'choices'      => apply_filters( "wdp_" . WDP_Discount_Message::CONTEXT_CHECKOUT . "_discount_message_places", array(
	...
	protected function init() {
		$this->options['wdp_product_bulk_table'] = array(
			'key'      => WDP_Range_Discounts_Table::CONTEXT_PRODUCT_PAGE,
		...
		$this->options['wdp_category_bulk_table'] = array(
			'key'      => WDP_Range_Discounts_Table::CONTEXT_CATEGORY_PAGE,
		...
		$this->options['wdp_discount_message'] = array(
			'key'      => WDP_Discount_Message::PANEL_KEY,
