...
class WDP_Rule_Range_Adjustments_Qty_Based_Variation implements WDP_Rule_Range_Adjustments_Qty_Based {
	private $key = 'variation';
	private $rule_id;
	...
	public static function get_label() {
		return __( 'Qty based on variation', 'advanced-dynamic-pricing-for-woocommerce' );
	}
